...
public:
	...
	// Not yet implemented
	void BFS(int startVertex) const; // Breadth-first search algorithm
	...
	void SaveProtein(string file_name, Protein& p) const; // Saves protein info to an external .txt file
	...
	MatrixGraph<Protein>* cloneNetwork(MatrixGraph<T>* network); // Copies the network.
